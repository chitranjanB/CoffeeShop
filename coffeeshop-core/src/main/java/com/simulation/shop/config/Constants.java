...
public class Config {
	public static final String BEANS_INVENTORY = "beans%s.txt";
	public static final String MILK_INVENTORY = "milk%s.txt";
	public static final String COFFEE_INFO = "data.txt";

	public static final String CUSTOMER_PREFIX ="customer-%s";
	public static final String COFFEE_FORMAT ="coffee-%s.zip";
